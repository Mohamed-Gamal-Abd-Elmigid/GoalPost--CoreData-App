...
class GoalsVC: UIViewController {
    ...
    {
        guard let creatGoalVC = storyboard?.instantiateViewController(withIdentifier : "CreateGoalVC")
            else
            {return}
...
extension GoalsVC : UITableViewDelegate , UITableViewDataSource
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]?
    {
        ...
        let addAction = UITableViewRowAction(style: .normal, title: "ADD 1")
        ...
        addAction.backgroundColor = #colorLiteral(red: 1, green: 0.8, blue: 0, alpha: 0.6983893408)
...
extension GoalsVC
{
    ...
    // Delete Item From Core Data and my List
    func removeGoal(atIndexPath indexPath : IndexPath)
    {
        ...
        {
            try managedContext.save()
            print("Successfuly removes the goal")
        }
        catch
        {
